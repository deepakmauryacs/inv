            ...
            <div class="row">
               <div class="col-md-4 mb-3">
                  ...
                  <select class="form-control  filter" id="company" name="company">  
                     ...
                     <?php
                     $data = $this->db->get_where('tbl_company',['id >'=>0])->result();
                     foreach($data as $row){
                      ?>
               ...
               <div class="col-md-4 mb-3">
                  <label class="form-label"> By Stock Type </label>
                  <select class="form-control  filter" id="stocktype" name="stocktype">  
                     <option value="" selected>All</option>
   ...
   $(document).ready(function(){
     ...
     function fill_datatable()
     {
      ...
      var dataTable = $('#datatable').DataTable({
       ...
       "ajax" : {
        url:"<?php echo base_url('Admin/Available_items/getAvailableList');?>",
        type:"POST",
        data:{company:company,stocktype:stocktype,associate:associate}
       }
      });
     }
