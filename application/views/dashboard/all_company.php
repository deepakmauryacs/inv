            ...
            <div class="card">
               <div class="card-body">
                  <div class="head d-flex justify-content-between align-items-center mb-4">
                     ...
                     <a  href="<?php  echo base_url('Admin/Company') ?>" style="border-radius: 0px;" class="btn btn-primary waves-effect waves-light">Add Company</a>
                  </div>
   ...
   $(document).ready(function(){
     ...
     function fill_datatable()
     {
      ...
      var dataTable = $('#datatable').DataTable({
       ...
       //         ],
       "ajax" : {
        url:"<?php echo base_url('Admin/Company/getCompanyList');?>",
        type:"POST",
        data:{}
       }
      });
   ...
   function showDetails(id)
       ...
       function delete_data(delete_id)
        {
            ...
            $('#delete_url').val("<?php echo base_url(); ?>Admin/company/delete_item");
     ...
     /*$(document).on('click', '.delete1', function(){  
              var service_id = $(this).attr("id");  
               ...
               if (result.value) {
                     $.ajax({
                        url:"<?php echo base_url(); ?>Admin/company/delete_item",  
                        method:"POST",  
